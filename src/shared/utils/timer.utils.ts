import { type TimerState } from '../../features/timer/models/timer.model';
import { type SettingsState } from '../../features/settings/models/settings.model';
import { type TaskState } from '../../features/tasks/models/task.model';
...
export function getCurrentSession(
  ...
  const activeTask = tasksState.find((t) => t.id === activeTaskId);
